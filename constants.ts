...
export const API_ROUTES = {
  ...
  AQUASCAN_OVERLAY_NDWI: '/api/aquascan/overlays/ndwi',
  AQUASCAN_OVERLAY_WATER_EXTENT: '/api/aquascan/overlays/water-extent',
  AQUASCAN_OVERLAY_FLOOD_WET: '/api/aquascan/overlays/flood-wet',
  AQUASCAN_OVERLAY_RISK_ZONES: '/api/aquascan/overlays/risk-zones',
  AQUASCAN_OVERLAY_FLOW_DIRECTION: '/api/aquascan/overlays/flow-direction',
