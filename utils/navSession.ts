...
export const ALLOWED_APP_VIEWS = new Set<string>([
  // Keep in sync with `export type View` in App.tsx (session restore rejects unknown ids).
  'mainMenu',
  'categorySelection',
  'categoryGateway',
  'categoryModeShell',
  ...
  'impactHub',
  'airQualityMonitor',
  'emissionsIntegrityAudit',
  'carbEmissionsAudit',
  'hazardousWasteAudit',
  'environmentalIntelligenceHub',
  'dpalInfographicsGallery',
  'epaGhgLive',
  'epaGhgFacilityDetail',
  'envirofactsGeoIntelligence',
  'previewEnvironmentalCommandCenter',
  'previewEnvironmentalIntelligenceHub',
  'previewFuelStorageAudit',
  'previewEvidencePacket',
  'previewModule',
