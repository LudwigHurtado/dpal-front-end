...
import ImpactStandaloneRoot from './components/ImpactStandaloneRoot';
  ...
  return (
    ...
    <div className="dpal-app transition-all duration-300 selection:bg-cyan-500/25 overflow-x-hidden">
      ...
      <main className={`container mx-auto ${isMobileCommunityFeed ? 'px-0' : 'px-4'} flex-grow relative z-10 ${useMobileLayout ? (isMobileCommunityFeed ? 'pt-0 pb-0' : 'pt-4 pb-24') : 'py-8'} ${['mainMenu', 'hub', 'categorySelection', 'categoryGateway', 'categoryModeShell', 'heroHub', 'transparencyDatabase', 'storage', 'resolutionLayer', 'missionMarketplace', 'marketplaceMissionDetail', 'missionAssignmentV2', 'createMission'].includes(currentView) && !isMobileCommunityFeed ? 'pb-24' : ''}`}>
        ...
        {currentView === 'impactHub' && <ImpactStandaloneRoot />}
        ...
        {currentView === 'satelliteAccountability' && (
          <SatelliteAccountabilityPage onReturn={() => goBack('environmentalIntelligenceHub')} />
        )}
        ...
        {currentView === 'forestIntegrity' && (
          <ForestIntegrityPage onReturn={() => goBack('environmentalIntelligenceHub')} />
        )}
        {currentView === 'hyperspectralPlasticWatch' && (
          <HyperspectralPlasticWatchPage onReturn={() => goBack('environmentalIntelligenceHub')} />
        )}
        ...
        {currentView === 'emissionsIntegrityAudit' && (
          <EmissionsIntegrityAuditPage
            onReturn={() => goBack('mainMenu')}
          />
        )}
        ...
        {currentView === 'waterOperationsEngine' && (
          <WaterMonitorView
            onReturn={() => goBack('mainMenu')}
            hero={hero}
            onOpenAquaScan={() => setCurrentView('aquaScanWater')}
          />
        )}
