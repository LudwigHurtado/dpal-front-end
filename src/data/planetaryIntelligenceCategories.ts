...
export const PLANETARY_INTELLIGENCE_CATEGORIES: PlanetaryIntelligenceCategory[] = [
  { id: 'carbon-credit-integrity', title: 'Carbon Credit Integrity Audits', icon: 'carbon', href: '/carbon-compliance' },
  ...
  { id: 'blue-carbon', title: 'Blue Carbon MRV', icon: 'ocean', href: '/ecology' },
  ...
  { id: 'ag-mrv', title: 'Agriculture Carbon & Water Efficiency MRV', icon: 'agriculture', href: '/afolu' },
