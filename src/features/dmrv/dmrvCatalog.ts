...
export const DMRV_FAMILIES: DmrvFamilyDef[] = [
  {
    ...
    hex: '#4A7C44',
    types: [
      type('forest-land-use', 'Forest / Land Use', 'Forest carbon stocks, deforestation, degradation, regrowth, and enhancement.', ['Satellite', 'Field Plots', 'LiDAR', 'Biomass Data', 'Activity Data'], ['Land cover change', 'Deforestation alerts', 'Carbon stock trend'], { purpose: 'Monitor forest carbon stocks and land-cover integrity for MRV screening.', requiredInputs: ['AOI polygon', 'Forest baseline period', 'Activity / management records'], satelliteLayers: ['Forest cover', 'NDVI / NBR', 'Deforestation alert layers'], groundTruthRequirements: ['Plot biomass or inventory when claiming stock change'] }),
      ...
      type('grassland-savanna', 'Grassland / Savanna', 'Soil carbon, biomass, grazing, and fire management outcomes.', ['Satellite', 'Fire Data', 'Grazing Data', 'Soil Samples', 'Weather Data'], ['Fire regime', 'Grazing intensity', 'Biomass dynamics'], { purpose: 'Assess grassland carbon and disturbance regimes for land-based MRV.' }),
  ...
  },
  {
    ...
    types: [
      ...
      type('freshwater-watershed', 'Freshwater / Watershed', 'Watershed condition, stream networks, and basin-scale indicators.', ['Satellite', 'USGS / public hydrology', 'AOI boundary', 'Field samples'], ['Basin stress', 'Land-use pressure'], { purpose: 'Frame freshwater and watershed-scale MRV with public hydrology where available.' }),
