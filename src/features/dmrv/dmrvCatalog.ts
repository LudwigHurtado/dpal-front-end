...
export const DMRV_FAMILIES: DmrvFamilyDef[] = [
  {
    ...
    description: 'Forest, agriculture, grassland, AFOLU, and land-carbon MRV pathways.',
    hex: '#4A7C44',
    types: [
      type('forest-land-use', 'Forest / Land Use', 'Forest carbon stocks, deforestation, degradation, regrowth, and enhancement.', ['Satellite Imagery', 'Field Plots', 'LiDAR', 'Biomass Data', 'Activity Data'], ['Land cover change', 'Deforestation alerts', 'Carbon stock trend'], { purpose: 'Monitor forest carbon stocks and land-cover integrity for MRV screening.', requiredInputs: ['AOI polygon', 'Forest baseline period', 'Activity / management records'], satelliteLayers: ['Forest cover', 'NDVI / NBR', 'Deforestation alert layers'], groundTruthRequirements: ['Plot biomass or inventory when claiming stock change'] }),
      ...
      type('grassland-savanna', 'Grassland / Savanna', 'Soil carbon, biomass, grazing, and fire management outcomes.', ['Satellite Imagery', 'Fire Data', 'Grazing Data', 'Soil Samples', 'Weather Data'], ['Fire regime', 'Grazing intensity', 'Biomass dynamics'], { purpose: 'Assess grassland carbon and disturbance regimes for land-based MRV.' }),
      type('afolu-land-carbon', 'AFOLU / Land Carbon', 'Investor-facing land-use carbon projects, missions, and proof workflows.', ['Project boundary', 'Mission proof', 'MRV score inputs', 'Satellite screening'], ['Project readiness', 'Proof completeness', 'Validator queue'], { purpose: 'Coordinate AFOLU project proof, missions, and carbon readiness — often local-first until synced.' }),
      type('soil-carbon', 'Soil Carbon & Land Management', 'Soil organic carbon trends under land-management scenarios.', ['Soil Samples', 'Management Data', 'Satellite Imagery', 'Weather Data'], ['SOC trend', 'Management attribution'], { purpose: 'Evaluate soil organic carbon claims tied to explicit management actions.' }),
  ...
  },
  {
    ...
    types: [
      ...
      type('freshwater-watershed', 'Freshwater / Watershed', 'Watershed condition, stream networks, and basin-scale indicators.', ['Satellite Imagery', 'USGS / public hydrology', 'AOI boundary', 'Field samples'], ['Basin stress', 'Land-use pressure'], { purpose: 'Frame freshwater and watershed-scale MRV with public hydrology where available.' }),
      ...
      type('water-quality', 'Water Quality', 'Nutrients, contaminants, and compliance-oriented water readings.', ['Lab results', 'Sensor feeds', 'Public monitoring stations', 'AOI'], ['Parameter exceedance', 'Trend vs baseline'], { purpose: 'Organize water-quality evidence for MRV and accountability packets.' }),
  ...
  },
  {
    ...
    hex: '#705196',
    types: [
      type('urban-built', 'Urban / Built Environment', 'Green cover, building emissions, and heat island mitigation.', ['Satellite Imagery', 'Building Data', 'Energy Data', 'Air Quality'], ['Canopy cover', 'Heat island'], { purpose: 'Evaluate urban environmental claims with building and canopy context.' }),
  ...
  },
  {
    ...
    description: 'Facility claims, disclosure comparison, and corporate MRV.',
    hex: '#2C5282',
    types: [
