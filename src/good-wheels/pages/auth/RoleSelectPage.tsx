          ...
          return (
            ...
            >
              ...
              <div style={{ position: 'relative', height: 220, overflow: 'hidden' }}>
                ...
                {/* Badge — top-right */}
                <span style={{ position: 'absolute', top: 12, right: 12, fontSize: 9, fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.18em', color: 'white', background: r.accent, borderRadius: 20, padding: '4px 10px' }}>
                  {r.badge}
                </span>
                {/* Role name on photo */}
