...
import businessWorkflowRoutes from '../environmental-intelligence/businessWorkflows/businessWorkflowRoutes';
...
router.use('/business-workflows', businessWorkflowRoutes);
