...
import carbAuditRouter from './routes/carbAudit';
...
import forestIntegrityRouter from './routes/forestIntegrity';
import hyperspectralPlasticWatchRouter from './routes/hyperspectralPlasticWatch';
...
import situationCmiRouter from './routes/situationCmi';
...
app.use('/api/carb-audit', carbAuditRouter);
...
app.use('/api/forest-integrity', forestIntegrityRouter);
app.use('/api/hyperspectral-plastic-watch', hyperspectralPlasticWatchRouter);
app.use('/api/hyperspectral-plastic', hyperspectralPlasticWatchRouter);
...
app.use('/api/situation', situationCmiRouter);
