...
export function buildCarbReport(input: BuildCarbReportInput): CarbSpecializedReport {
  ...
  return {
    ...
    baselineRawRow: input.baselineRawRow ?? null,
    currentRawRow: input.currentRawRow ?? null,
    ...
    reportQualityRating: input.reportQualityRating,
    dataReadiness: input.dataReadiness,
    investigationFindings: input.investigationFindings,
    sourceIntegrityWarnings: input.sourceIntegrityWarnings ?? [],
